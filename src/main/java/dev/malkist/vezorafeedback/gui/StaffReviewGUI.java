...
public class StaffReviewGUI extends BaseGUI {

    private final VezoraFeedback plugin;

    public StaffReviewGUI(VezoraFeedback plugin) {

        this.plugin = plugin;

        inventory = Bukkit.createInventory(this, 54, "§8Select Staff");
    ...
    private ItemStack createHead(String staff){
        ...
        OfflinePlayer offlinePlayer = Bukkit.getOfflinePlayer(staff);
